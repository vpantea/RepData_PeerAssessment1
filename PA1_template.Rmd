...
```
So, replacing steps column NAs values in input dataset with the same interval mean value measured for all days has the impact of raising a little the steps mean value. But the daily steps max value measured in the missing values  dataset 
```{r}
